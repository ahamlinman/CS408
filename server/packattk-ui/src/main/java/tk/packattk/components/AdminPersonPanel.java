...
public class AdminPersonPanel extends CustomComponent {
	...
	private Collection<Person> getPersonList() {
		...
		p.add(new Person("026442222", "Torvalds", "Linus", "Finland", 0, false, "torvalds", "test"));
		p.add(new Person("026443333", "Gates", "Bill", "Redmond", 0, false, "gates", "test"));
		p.add(new Person("026441111", "Jobs", "Steve", "Cupertino", 0, false, "sjobs", "test"));
