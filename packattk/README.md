...
- packattk-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- packattk-ui: main application module, development time
- packattk-production: module that produces a production mode WAR for deployment
